...
class NvFileMenu(NvMenu):
    def __init__(self, root, menu_bar, view, **kw):
        ...
        self.add_command(label="Render Markdown to HTML", underline=7,
        ...
        self.add_command(label="Render reST to HTML", underline=7,
                              command=self.cmd_rest, accelerator="Ctrl+R")
        self.root.bind_all("<Control-r>", self.cmd_rest)

        self.add_separator()

        self.add_command(label="Exit", underline=1,
                              command=self.root.handler_close, accelerator="Ctrl+Q")
        self.root.bind_all("<Control-q>", self.root.handler_close)
